...
- [Day Skipper (EU)](DaySkipperEU.md)
- [Day Skipper (US)](DaySkipperUS.md)
- [Day Skipper (JPN) - 7.8k](DaySkipperJPN-7.8k.md) (this program)
...
3. The language for your Switch must be set to Japanese (日本語).
4. Set the date to January 1st 2000.
